...
!function(t, e) {
    ...
    function Z(t) {
        ...
        for (r = t.length; r--; )
            t[r] && (t[r]._gsap || (t[r]._gsap = new Bt(t[r],e))) || t.splice(r, 1);
        return t
    }
    function $(t) {
    ...
    function ya(t) {
        return t._end = ba(t._start + (t._tDur / Math.abs(t._ts || t._rts || V) || 0))
    }
    function za(t, e) {
        var r = t._dp;
        return r && r.smoothChildTiming && t._ts && (t._start = ba(r._time - (0 < t._ts ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts)),
        ya(t),
        r._dirty || sa(r, t)),
        t
    }
    function Aa(t, e) {
        ...
        (!e._dur || yt(0, e.totalDuration(), r) - e._tTime > V) && e.render(r, !0)),
    ...
    function Ba(t, e, r, i) {
        ...
        e._end = ba(e._start + (e.totalDuration() / Math.abs(e.timeScale()) || 0)),
    ...
    function Ha(t) {
        return t instanceof Lt ? sa(t) : Ga(t, t._dur)
    }
    function Ja(t, e) {
        ...
        1 < r ? Ja(t, e.substr(0, r - 1)) + i : s + i) : null == e ? s : +e
    }
    function Ka(t, e) {
        return t || 0 === t ? e(t) : e
    }
        ...
        function(t, e, r) {
            ...
            if (!p) {
                ...
                u = h = 0; u < d; u++)
                    a = u % f - i,
                    s = n - (u / f | 0),
                    p[u] = o = b ? Math.abs("y" === b ? s : a) : H(a * a + s * s),
                    h < o && (h = o),
                    o < l && (l = o);
                "random" === m && Sa(p),
                p.max = h - l,
                p.min = l,
                p.v = d = (parseFloat(_.amount) || parseFloat(_.each) * (d < f ? d - 1 : b ? "y" === b ? d / f : f : Math.max(f, d / f)) || 0) * ("edges" === m ? -1 : 1),
                p.b = d < 0 ? g - d : g,
                p.u = Ma(_.amount || _.each) || 0,
                c = c && d < 0 ? Et(c) : c
            }
    ...
    function Ua(e) {
        ...
        return function(t) {
            return Math.floor(Math.round(parseFloat(t) / e) * e * r) / r + (q(t) ? 0 : Ma(t))
        }
    }
    function Va(u, t) {
        var h, l, e = tt(u);
        ...
        (l = !q(u[0])) && (h *= h)) : u = Ua(u.increment)),
        Ka(t, e ? p(u) ? function(t) {
            return l = u(t),
            Math.abs(l - t) <= h ? l : t
        }
        : function(t) {
    ...
    function Wa(t, e, r, i) {
        return Ka(tt(t) ? !e : !0 === r ? !!(r = 0) : !i, function() {
    ...
    function bb(t) {
        for (var e, r, i, n, a = 0, s = ""; ~(e = t.indexOf("random(", a)); )
            ...
            s += t.substr(a, e - a) + Wa(n ? r : +r[0], n ? 0 : +r[1], +r[2] || 1e-5),
            a = i + 1;
    ...
    function mb(t, e, r) {
        var i, n, a, s, o, u, h, l, f, d, p = t ? q(t) ? [t >> 16, t >> 8 & kt, t & kt] : 0 : Mt.black;
        if (!p) {
    ...
    function nb(t) {
        var r = []
          , i = []
          , n = -1;
        return t.split(Ot).forEach(function(t) {
            var e = t.match(it) || [];
            r.push.apply(r, e),
            i.push(n += e.length + 1)
        }),
    ...
    function ob(t, e, r) {
        var i, n, a, s, o = "", u = (t + o).match(Ot), h = e ? "hsla(" : "rgba(", l = 0;
        if (!u)
            return t;
        if (u = u.map(function(t) {
            return (t = mb(t, e, 1)) && h + (e ? t[0] + "," + t[1] + "%," + t[2] + "%," + t[3] : t.join(",")) + ")"
        }),
        r && (a = nb(t),
        (i = r.c).join(o) !== a.c.join(o)))
            for (s = (n = t.replace(Ot, "1").split(it)).length - 1; l < s; l++)
                o += n[l] + (~i.indexOf(l) ? u.shift() || h + "0,0,0,0)" : (a.length ? a : u.length ? u : r).shift());
        if (!n)
            for (s = (n = t.split(Ot)).length - 1; l < s; l++)
                o += n[l] + u[l];
        return o + n[s]
    }
    function rb(t) {
    ...
    function Cb(t, e) {
        for (var r, i = t._first; i; )
            i instanceof Lt ? Cb(i, e) : !i.vars.yoyoEase || i._yoyo && i._repeat || i._yoyo === e || (i.timeline ? Cb(i.timeline, e) : (r = i._ease,
            i._ease = i._yEase,
            i._yEase = r,
            i._yoyo = e)),
            i = i._next
    ...
    var R, B, i, n, a, h, l, f, d, c, m, g, y, b, T, w, x, k, C, A, S, D, z, E, F, I, Y = {
        autoSleep: 120,
        force3D: "auto",
        nullTargetWarn: 1,
        units: {
        ...
        overwrite: !1,
        delay: 0
    }, U = 1e8, V = 1 / U, X = 2 * Math.PI, j = X / 4, J = 0, H = Math.sqrt, K = Math.cos, W = Math.sin, Q = "function" == typeof ArrayBuffer && ArrayBuffer.isView || function() {}
    , tt = Array.isArray, et = /(?:-?\.?\d|\.)+/gi, rt = /[-+=.]*\d+[.e\-+]*\d*[e\-\+]*\d*/g, it = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, nt = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, at = /[+-]=-?[\.\d]+/, st = /[#\-+.]*\b[a-z\d-=+%.]+/gi, ot = {}, ut = {}, ht = [], lt = {}, ft = {}, dt = {}, pt = 30, _t = [], ct = "", mt = function _merge(t, e) {
        for (var r in e)
            t[r] = e[r];
        return t
        ...
        return !o(t) || e || !n && At() ? tt(t) ? function _flatten(t, e, r) {
            ...
            t.forEach(function(t) {
                return o(t) && !e || Pa(t, 1) ? r.push.apply(r, Tt(t)) : r.push(t)
            }) || r
        }(t, e) : Pa(t) ? bt.call(t, 0) : t ? [t] : [] : bt.call(a.querySelectorAll(t), 0)
    }, wt = function mapRange(e, t, r, i, n) {
        var a = t - e
          , s = i - r;
        return Ka(n, function(t) {
            return r + ((t - e) / a * s || 0)
        })
    ...
    b = {
        ...
        return !c && Ct.wake()
    }, St = {}, Dt = /^[\d.\-M][\d.\-,\s]/, zt = /["']/g, Et = function _invertEase(e) {
        return function(t) {
            return 1 - e(1 - t)
        }
    }, Ft = function _parseEase(t, e) {
        return t && (p(t) ? t : St[t] || Ab(t)) || e
    };
    function sk(t) {
    ...
    function Vl(t) {
        return t < I ? F * t * t : t < .7272727272727273 ? F * Math.pow(t - 1.5 / 2.75, 2) + .75 : t < .9090909090909092 ? F * (t -= 2.25 / 2.75) * t + .9375 : F * Math.pow(t - 2.625 / 2.75, 2) + .984375
    }
    ...
    G.ease = St["quad.out"],
    aa("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", function(t) {
        return ct += t + "," + t + "Params,"
    });
    var Rt, Bt = function GSCache(t, e) {
        this.id = J++,
        (t._gsap = this).target = t,
        this.harness = e,
        this.get = e ? e.get : _,
        this.set = e ? e.getSetter : Ht
    }, It = ((Rt = Animation.prototype).delay = function delay(t) {
    ...
    Rt.totalDuration = function totalDuration(t) {
        ...
        Ga(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1))) : this._tDur
    }
    ,
    ...
    Rt.paused = function paused(t) {
        ...
        this._ts = this._rts,
        this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && (this._tTime -= V) && Math.abs(this._zTime) !== V))),
        this) : this._ps
    }
    ,
    ...
    Rt.seek = function seek(e, r) {
        return this.totalTime(Ja(this, e), t(r))
    }
    ,
    ...
    Rt.then = function then(t) {
        ...
        return new Promise(function(e) {
            ...
            var r = p(t) ? t : ha;
            i._initted && 1 === i.totalProgress() && 0 <= i._ts || !i._tTime && i._ts < 0 ? ln() : i._prom = ln
        }
        )
    }
    ,
    ...
    var Lt = function(n) {
        ...
        return e.to = function to(t, e, r, i) {
            return new Xt(t,da(arguments, 0, this),Ja(this, q(e) ? i : r)),
            this
        }
        ,
        e.from = function from(t, e, r, i) {
            return new Xt(t,da(arguments, 1, this),Ja(this, q(e) ? i : r)),
            this
        }
        ,
        e.fromTo = function fromTo(t, e, r, i, n) {
            return new Xt(t,da(arguments, 2, this),Ja(this, q(e) ? n : i)),
            this
        }
        ,
        e.set = function set(t, e, r) {
            ...
            new Xt(t,e,Ja(this, r),1),
            this
        }
        ,
        e.call = function call(t, e, r) {
            return Ba(this, Xt.delayedCall(0, t, e), Ja(this, r))
        }
        ,
        ...
        e.render = function render(t, e, r) {
            var i, n, a, s, o, u, h, l, f, d, p, _, c = this._time, m = this._dirty ? this.totalDuration() : this._tDur, g = this._dur, v = this !== B && m - V < t && 0 <= t ? m : t < V ? 0 : t, y = this._zTime < 0 != t < 0 && (this._initted || !g);
            if (v !== this._tTime || r || y) {
                ...
                (v === m && m >= this.totalDuration() || !v && c) && (f !== this._start && Math.abs(l) === Math.abs(this._ts) || this._lock || (!t && g || !(v === m && 0 < this._ts || !v && this._ts < 0) || ra(this, 1),
        ...
        e.totalTime = function totalTime(t, e) {
            ...
            !this._dp && this._ts && (this._start = ba(Ct.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))),
        ...
        e.addLabel = function addLabel(t, e) {
            return this.labels[t] = Ja(this, e),
            this
        }
        ,
        ...
        e.getTweensOf = function getTweensOf(t, e) {
            for (var r, i = [], n = Tt(t), a = this._first, s = q(e); a; )
                a instanceof Xt ? ca(a._targets, n) && (s ? (!qt || a._initted && a._ts) && a.globalTime(0) <= e && a.globalTime(a.totalDuration()) > e : !e || a.isActive()) && i.push(a) : (r = a.getTweensOf(n, e)).length && i.push.apply(i, r),
                a = a._next;
            return i
        }
        ,
        e.tweenTo = function tweenTo(t, e) {
            ...
            var r = this
              ...
              , u = Xt.to(r, ia({
                ...
                time: i,
                overwrite: "auto",
                duration: e.duration || Math.abs((i - (n && "time"in n ? n.time : r._time)) / r.timeScale()) || V,
                onStart: function onStart() {
                    r.pause();
                    var t = e.duration || Math.abs((i - r._time) / r.timeScale());
                    u._dur !== t && Ga(u, t, 0, 1).render(u._time, !0, !0),
                    a && a.apply(u, s || [])
                }
            }, e));
        ...
        e.totalDuration = function totalDuration(t) {
            ...
            if (a._dirty) {
                for (i = a.parent; s; )
                    ...
                    s = e;
                Ga(a, a === B && a._time > n ? a._time : n, 1, 1),
                a._dirty = 0
            }
            return a._tDur
        }
    ...
    function Ob(t, e, r, i, n, a) {
        var u, h, l, f;
        if (ft[t] && !1 !== (u = new ft[t]).init(n, u.rawVars ? e[t] : function _processVars(t, e, r, i, n) {
            if (p(t) && (t = Gt(t, n, e, r, i)),
            !s(t) || t.style && t.nodeType || tt(t) || Q(t))
                return o(t) ? Gt(t, n, e, r, i) : t;
            var a, u = {};
            for (a in t)
                u[a] = Gt(t[a], n, e, r, i);
            return u
    ...
    var qt, Nt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
        p(i) && (i = i(n || 0, t, a));
        var l, f = t[e], d = "get" !== r ? r : p(f) ? h ? t[e.indexOf("set") || !p(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](h) : t[e]() : f, _ = p(f) ? h ? $t : Jt : jt;
        if (o(i) && (~i.indexOf("random(") && (i = bb(i)),
        "=" === i.charAt(1) && (i = parseFloat(d) + parseFloat(i.substr(2)) * ("-" === i.charAt(0) ? -1 : 1) + (Ma(d) || 0))),
        d !== i)
            return isNaN(d * i) ? (f || e in t || M(e, i),
            function _addComplexStringPropTween(t, e, r, i, n, a, s) {
                var o, u, h, l, f, d, p, _, c = new ie(this._pt,t,e,0,1,Zt,null,n), m = 0, g = 0;
                for (c.b = r,
                c.e = i,
                r += "",
                (p = ~(i += "").indexOf("random(")) && (i = bb(i)),
                a && (a(_ = [r, i], t, e),
                r = _[0],
                i = _[1]),
            ...
            .call(this, t, e, d, i, _, u || Y.stringFilter, h)) : (l = new ie(this._pt,t,e,+d || 0,i - (d || 0),"boolean" == typeof f ? Wt : Kt,0,_),
            h && (l.fp = h),
            s && l.modifier(s, this, t),
            this._pt = l)
    }, Yt = function _initTween(e, r) {
        var i, n, a, s, o, u, h, l, f, d, p, _, c, m = e.vars, g = m.ease, v = m.startAt, y = m.immediateRender, b = m.lazy, T = m.onUpdate, w = m.onUpdateParams, x = m.callbackScope, k = m.runBackwards, M = m.yoyoEase, O = m.keyframes, P = m.autoRevert, C = e._dur, A = e._startAt, S = e._targets, D = e.parent, z = D && "nested" === D.data ? D.parent._targets : S, E = "auto" === e._overwrite && !R, F = e.timeline;
        if (!F || O && g || (g = "none"),
        e._ease = Ft(g, G.ease),
        e._yEase = M ? Et(Ft(!0 === M ? g : M, G.ease)) : 0,
        M && e._yoyo && !e._repeat && (M = e._yEase,
        e._yEase = e._ease,
        e._ease = M),
        !F) {
            if (_ = (l = S[0] ? $(S[0]).harness : 0) && m[l.prop],
            i = ma(m, ut),
            A && A.render(-1, !0).kill(),
            v) {
                if (ra(e._startAt = Xt.set(S, ia({
                    data: "isStart",
                    overwrite: !1,
                    parent: D,
                    immediateRender: !0,
            ...
            b = C && t(b) || b && !C,
            n = 0; n < S.length; n++) {
                if (h = (o = S[n])._gsap || Z(S)[n]._gsap,
                e._ptLookup[n] = d = {},
                lt[h.id] && ht.length && ea(),
                p = z === S ? n : z.indexOf(o),
                l && !1 !== (f = new l).init(o, _ || i, e, p, z) && (e._pt = s = new ie(e._pt,o,f.name,0,1,f.render,f,0,f.priority),
                ...
                !l || _)
                    for (a in i)
                        ft[a] && (f = Ob(a, i, e, p, o, z)) ? f.priority && (u = 1) : d[a] = s = Nt.call(e, o, a, "get", i[a], p, z, 0, m.stringFilter);
                e._op && e._op[n] && e.kill(o, e._op[n]),
                E && e._pt && (qt = e,
                B.killTweensOf(o, d, e.globalTime(0)),
                c = !e.parent,
                qt = 0),
                e._pt && b && (lt[h.id] = 1)
            }
    ...
    }, Gt = function _parseFuncOrString(t, e, r, i, n) {
        return p(t) ? t.call(e, r, i, n) : o(t) && ~t.indexOf("random(") ? bb(t) : t
    }, Ut = ct + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase", Vt = (Ut + ",id,stagger,delay,duration,paused,scrollTrigger").split(","), Xt = function(A) {
        function Tween(e, r, i, n) {
            var a;
            "number" == typeof r && (i.duration = r,
            r = i,
            i = null);
            var o, u, h, l, f, d, p, _, c = (a = A.call(this, n ? r : na(r), i) || this).vars, m = c.duration, g = c.delay, y = c.immediateRender, b = c.stagger, T = c.overwrite, w = c.keyframes, x = c.defaults, k = c.scrollTrigger, M = c.yoyoEase, O = a.parent, C = (tt(e) || Q(e) ? q(e[0]) : "length"in r) ? [e] : Tt(e);
            if (a._targets = C.length ? Z(C) : N("GSAP target " + e + " not found. https://greensock.com", !Y.nullTargetWarn) || [],
            a._ptLookup = [],
            a._overwrite = T,
            w || b || v(m) || v(g)) {
                if (r = a.vars,
                ...
                w)
                    ...
                    s(b))
                        for (f in b)
                            ~Ut.indexOf(f) && ((_ = _ || {})[f] = b[f]);
                    for (u = 0; u < l; u++) {
                        for (f in h = {},
                        r)
                            Vt.indexOf(f) < 0 && (h[f] = r[f]);
                        h.stagger = 0,
                        M && (h.yoyoEase = M),
                        _ && mt(h, _),
                        d = C[u],
                        h.duration = +Gt(m, _assertThisInitialized(a), u, d, C),
                        h.delay = (+Gt(g, _assertThisInitialized(a), u, d, C) || 0) - a._delay,
            ...
            B.killTweensOf(C),
            qt = 0),
            O && Aa(O, _assertThisInitialized(a)),
            (y || !m && !w && a._start === ba(O._time) && t(y) && function _hasNoPausedAncestors(t) {
                return !t || t._ts && _hasNoPausedAncestors(t.parent)
            }(_assertThisInitialized(a)) && "nested" !== O.data) && (a._tTime = -V,
        ...
        return e.render = function render(t, e, r) {
            var i, n, a, s, o, u, h, l, f, d = this._time, p = this._tDur, _ = this._dur, c = p - V < t && 0 <= t ? p : t < V ? 0 : t;
            if (_) {
                if (c !== this._tTime || !t || r || !this._initted && this._tTime || this._startAt && this._zTime < 0 != t < 0) {
                    ...
                    n = this._pt; n; )
                        n.r(h, n.d),
                        n = n._next;
                    l && l.render(t < 0 ? t : !i && u ? -V : l._dur * h, e, r) || this._startAt && (this._zTime = t),
                    ...
                    !t && _ || !(c === this._tDur && 0 < this._ts || !c && this._ts < 0) || ra(this, 1),
                    e || t < 0 && !d || !c && !d || (xt(this, c === p ? "onComplete" : "onReverseComplete", !0),
                    !this._prom || c < p && 0 < this.timeScale() || this._prom()))
                }
            } else
                !function _renderZeroDurationTween(t, e, r, i) {
                    var n, a, s = t.ratio, o = e < 0 || !e && s && !t._start && t._zTime > V && !t._dp._lock || (t._ts < 0 || t._dp._ts < 0) && "isFromStart" !== t.data && "isStart" !== t.data ? 0 : 1, u = t._rDelay, h = 0;
                    if (u && t._repeat && (h = yt(0, t._tDur, e),
                    gt(h, u) !== (a = gt(t._tTime, u)) && (s = 1 - o,
                    t.vars.repeatRefresh && t._initted && t.invalidate())),
                    o !== s || i || t._zTime === V || !e && t._zTime) {
                        ...
                        (e >= t._tDur || e < 0) && t.ratio === o && (o && ra(t, 1),
        ...
        ,
        e.invalidate = function invalidate() {
            return this._pt = this._op = this._startAt = this._onUpdate = this._lazy = 0,
            this._ptLookup = [],
        ...
        e.kill = function kill(t, e) {
            ...
            !(t || e && "all" !== e))
                ...
                this.parent ? gb(this) : this;
            if (this.timeline) {
                var r = this.timeline.totalDuration();
                return this.timeline.killTweensOf(t, e, qt && !0 !== qt.vars.overwrite)._first || gb(this),
                this.parent && r !== this.timeline.totalDuration() && Ga(this, this._dur * this.timeline._tDur / r, 0, 1),
                this
            }
            var i, n, a, s, u, h, l, f = this._targets, d = t ? Tt(t) : f, p = this._ptLookup, _ = this._pt;
            ...
            l = f.length; l--; )
                if (~d.indexOf(f[l]))
                    ...
                    s)
                        ...
                        delete n[u]),
                        "all" !== a && (a[u] = 1);
            return this._initted && !this._pt && _ && gb(this),
            this
        }
        ,
    ...
    var jt = function _setterPlain(t, e, r) {
      ...
      , Ht = function _getSetter(t, e) {
        return p(t[e]) ? Jt : r(t[e]) && t.setAttribute ? Zb : jt
    }
      ...
      , Qt = function _renderPropTweens(t, e) {
        for (var r = e._pt; r; )
            r.r(t, r.d),
            r = r._next
    }
    ...
    ot.TimelineLite = ot.TimelineMax = Lt,
    B = new Lt({
        sortChildren: !1,
        defaults: G,
    ...
    var ne = {
        ...
        defaults: function defaults(t) {
            return t && t.ease && (t.ease = Ft(t.ease, G.ease)),
            la(G, t || {})
        },
        ...
        registerEffect: function registerEffect(t) {
            ...
            ,
            r && (Lt.prototype[i] = function(t, e, r) {
        ...
        parseEase: function parseEase(t, e) {
            return arguments.length ? Ft(t, e) : St
        },
        ...
        exportRoot: function exportRoot(e, r) {
            ...
            B.remove(a),
            a._dp = 0,
            a._time = a._tTime = B._time,
            i = B._first; i; )
                n = i._next,
                !r && !i._dur && i instanceof Xt && i.vars.onComplete === i._targets[0] || Ba(a, i, i._start - i._delay),
                i = n;
            return Ba(B, a, 0),
            a
        },
        utils: {
            wrap: function wrap(e, t, r) {
                var i = t - e;
                return tt(e) ? $a(e, wrap(0, e.length), t) : Ka(r, function(t) {
                    return (i + (t - e) % i) % i + e
                })
            },
            wrapYoyo: function wrapYoyo(e, t, r) {
                var i = t - e
                  , n = 2 * i;
                return tt(e) ? $a(e, wrapYoyo(0, e.length - 1), t) : Ka(r, function(t) {
            ...
            interpolate: function interpolate(e, r, t, i) {
                ...
                if (!n) {
                    ...
                    if (!u) {
                        for (a in r)
                            Nt.call(d, e, a, "get", r[a]);
                        n = function func(t) {
                            return Qt(t, d) || (f ? e.p : e)
                        }
                    }
                }
                return Ka(t, n)
    ...
    }, lc("roundProps", Ua), lc("modifiers"), lc("snap", Va)) || ne;
    Xt.version = Lt.version = ae.version = "3.6.0",
    l = 1,
    u() && At();
    function Wc(t, e) {
    ...
    function kd(t, e, r) {
        ...
        return i[e] || i.getPropertyValue(e.replace(Be, "-$1").toLowerCase()) || i.getPropertyValue(e) || !r && kd(t, Ue(e) || e, 1) || ""
    }
    function nd() {
    ...
    function od(t) {
        var e, r = jd("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), i = this.parentNode, n = this.nextSibling, a = this.style.cssText;
        if (ue.appendChild(r),
        r.appendChild(this),
    ...
    function qd(e) {
        ...
        return r && (r.width || r.height) || e.getBBox === od || (r = od.call(e, !0)),
        !r || r.width || r.x || r.y ? r : {
            x: +pd(e, ["x", "cx", "x1"]) || 0,
            y: +pd(e, ["y", "cy", "y1"]) || 0,
            width: 0,
    ...
    function rd(t) {
        return !(!t.getCTM || t.parentNode && !t.ownerSVGElement || !qd(t))
    }
    function sd(t, e) {
        if (e) {
            var r = t.style;
            ...
            r.removeProperty(e.replace(Be, "-$1").toLowerCase())) : r.removeAttribute(e)
        }
    }
    function td(t, e, r, i, n, a) {
        var s = new ie(t._pt,e,r,0,1,a ? _c : $c);
        return (t._pt = s).b = i,
        s.e = n,
        t._props.push(r),
        s
    ...
    function vd(t, e, r, i) {
        var n, a, s, o, u = parseFloat(r) || 0, h = (r + "").trim().substr((u + "").length) || "px", l = le.style, f = Ie.test(e), d = "svg" === t.tagName.toLowerCase(), p = (d ? "client" : "offset") + (f ? "Width" : "Height"), _ = "px" === i, c = "%" === i;
        return i === h || !u || Ve[i] || Ve[h] ? u : ("px" === h || _ || (u = vd(t, e, r, "px")),
        o = t.getCTM && rd(t),
        !c && "%" !== h || !ze[e] && !~e.indexOf("adius") ? (l[f ? "width" : "height"] = 100 + (_ ? h : i),
        a = ~e.indexOf("adius") || "em" === i && t.appendChild && !d ? t : t.parentNode,
        o && (a = (t.ownerSVGElement || {}).parentNode),
        a && a !== oe && a.appendChild || (a = oe.body),
        (s = a._gsap) && c && s.width && f && s.time === Ct.time ? ba(u / s.width * 100) : (!c && "%" !== h || (l.position = kd(t, "position")),
        a === t && (l.position = "static"),
        a.appendChild(le),
        n = le[p],
        a.removeChild(le),
        l.position = "absolute",
        f && c && ((s = $(a)).time = Ct.time,
        s.width = a[p]),
        ba(_ ? n * u / 100 : n && u ? 100 / n * u : 0))) : (n = o ? t.getBBox()[f ? "width" : "height"] : t[p],
    ...
    function wd(t, e, r, i) {
        ...
        ze[e] && "transform" !== e ? (n = He(t, i),
        n = "transformOrigin" !== e ? n[e] : Ke(kd(t, Ye)) + " " + n.zOrigin + "px") : (n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(") || (n = je[e] && je[e](t, e, r) || kd(t, e) || _(t, e) || ("opacity" === e ? 1 : 0)),
        r && !~(n + "").trim().indexOf(" ") ? vd(t, e, n, r) + r : n
    }
    function xd(t, e, r, i) {
        if (!r || "none" === r) {
            var n = Ue(e, t, 1)
              , a = n && kd(t, n, 1);
            a && a !== r ? (e = n,
            r = a) : "borderColor" === e && (r = kd(t, "borderTopColor"))
        }
    ...
    function Fd(t) {
        var e = kd(t, Ne);
        return Ed(e) ? Je : e.substr(7).match(rt).map(ba)
    }
    function Gd(t, e) {
        var r, i, n, a, s = t._gsap || $(t), o = t.style, u = Fd(t);
        return s.svg && t.getAttribute("transform") ? "1,0,0,1,0,0" === (u = [(n = t.transform.baseVal.consolidate().matrix).a, n.b, n.c, n.d, n.e, n.f]).join(",") ? Je : u : (u !== Je || t.offsetParent || t === ue || s.svg || (n = o.display,
        o.display = "block",
        (r = t.parentNode) && t.offsetParent || (a = 1,
        i = t.nextSibling,
        ue.appendChild(t)),
        u = Fd(t),
        n ? o.display = n : sd(t, "display"),
        a && (i ? r.insertBefore(t, i) : r ? r.appendChild(t) : ue.removeChild(t))),
        e && 6 < u.length ? [u[0], u[1], u[4], u[5], u[12], u[13]] : u)
    }
    function Hd(t, e, r, i, n, a) {
        var s, o, u, h = t._gsap, l = n || Gd(t, !0), f = h.xOrigin || 0, d = h.yOrigin || 0, p = h.xOffset || 0, _ = h.yOffset || 0, c = l[0], m = l[1], g = l[2], v = l[3], y = l[4], b = l[5], T = e.split(" "), w = parseFloat(T[0]) || 0, x = parseFloat(T[1]) || 0;
        r ? l !== Je && (o = c * v - m * g) && (u = w * (-m / o) + x * (c / o) - (c * b - m * y) / o,
        w = w * (v / o) + x * (-g / o) + (g * b - v * y) / o,
        x = u) : (w = (s = qd(t)).x + (~T[0].indexOf("%") ? w / 100 * s.width : w),
        x = s.y + (~(T[1] || T[0]).indexOf("%") ? x / 100 * s.height : x)),
        i || !1 !== i && h.smooth ? (y = w - f,
        b = x - d,
        h.xOffset = p + (y * c + b * g) - y,
        h.yOffset = _ + (y * m + b * v) - b) : h.xOffset = h.yOffset = 0,
        h.xOrigin = w,
        h.yOrigin = x,
        h.smooth = !!i,
        h.origin = e,
        ...
        t.style[Ye] = "0px 0px",
        a && (td(a, h, "xOrigin", f, w),
        td(a, h, "yOrigin", d, x),
        td(a, h, "xOffset", p, h.xOffset),
        td(a, h, "yOffset", _, h.yOffset)),
        t.setAttribute("data-svg-origin", w + " " + x)
    }
    function Kd(t, e, r) {
        var i = Ma(e);
        return ba(parseFloat(e) + parseFloat(vd(t, "x", r + "px", i))) + i
    }
    function Rd(t, e, r, i, n, a) {
        ...
        t._pt = u = new ie(t._pt,e,r,i,d,Xc),
        u.e = p,
        u.u = "deg",
        t._props.push(r),
        u
    ...
    function Sd(t, e, r) {
        ...
        i = He(fe, 1),
        ze)
            (a = f[n]) !== (s = i[n]) && "perspective,force3D,transformOrigin,svgOrigin".indexOf(n) < 0 && (o = Ma(a) !== (h = Ma(s)) ? vd(r, n, a, h) : parseFloat(a),
            u = parseFloat(s),
            t._pt = new ie(t._pt,f,n,o,u - o,Wc),
            t._pt.u = h || 0,
            t._props.push(n));
        oe.body.removeChild(fe)
    }
    var se, oe, ue, he, le, fe, de, pe, _e = St.Power0, ce = St.Power1, me = St.Power2, ge = St.Power3, ve = St.Power4, ye = St.Linear, be = St.Quad, Te = St.Cubic, we = St.Quart, xe = St.Quint, ke = St.Strong, Me = St.Elastic, Oe = St.Back, Pe = St.SteppedEase, Ce = St.Bounce, Ae = St.Sine, Se = St.Expo, De = St.Circ, ze = {}, Ee = 180 / Math.PI, Fe = Math.PI / 180, Re = Math.atan2, Be = /([A-Z])/g, Ie = /(?:left|right|width|margin|padding|x)/i, Le = /[\s,\(]\S/, qe = {
        autoAlpha: "opacity,visibility",
        scale: "scaleX,scaleY",
        alpha: "opacity"
    }, Ne = "transform", Ye = Ne + "Origin", Ge = "O,Moz,ms,Ms,Webkit".split(","), Ue = function _checkPropPrefix(t, e, r) {
        var i = (e || le).style
          , n = 5;
        if (t in i && !r)
            return t;
        for (t = t.charAt(0).toUpperCase() + t.substr(1); n-- && !(Ge[n] + t in i); )
            ;
        return n < 0 ? null : (3 === n ? "ms" : 0 <= n ? Ge[n] : "") + t
    }, Ve = {
        deg: 1,
        rad: 1,
        turn: 1
        ...
        clearProps: function clearProps(t, e, r, i, n) {
            if ("isFromStart" !== n.data) {
                var a = t._pt = new ie(t._pt,e,r,0,0,Ad);
                return a.u = i,
                a.pr = -10,
                a.tween = n,
                t._props.push(r),
    ...
    }, Je = [1, 0, 0, 1, 0, 0], $e = {}, He = function _parseTransform(t, e) {
        var r = t._gsap || new Bt(t);
        if ("x"in r && !e && !r.uncache)
            return r;
        var i, n, a, s, o, u, h, l, f, d, p, _, c, m, g, v, y, b, T, w, x, k, M, O, P, C, A, S, D, z, E, F, R = t.style, B = r.scaleX < 0, I = "deg", L = kd(t, Ye) || "0";
        return i = n = a = u = h = l = f = d = p = 0,
        s = o = 1,
        r.svg = !(!t.getCTM || !rd(t)),
        m = Gd(t, r.svg),
        r.svg && (O = !r.uncache && t.getAttribute("data-svg-origin"),
        Hd(t, O || L, !!O || r.originIsAbsolute, !1 !== r.smooth, m)),
        _ = r.xOrigin || 0,
        c = r.yOrigin || 0,
        m !== Je && (b = m[0],
        T = m[1],
        ...
        o = Math.sqrt(x * x + w * w),
        u = b || T ? Re(T, b) * Ee : 0,
        (f = w || x ? Re(w, x) * Ee + u : 0) && (o *= Math.cos(f * Fe)),
        r.svg && (i -= _ - (_ * b + c * w),
        n -= c - (_ * T + c * x))) : (F = m[6],
        z = m[7],
        A = m[8],
        ...
        w = C = w * v - D * y),
        u = (g = Re(T, b)) * Ee,
        g && (O = b * (v = Math.cos(g)) + T * (y = Math.sin(g)),
        P = k * v + M * y,
        T = T * v - b * y,
        M = M * v - k * y,
        b = O,
        ...
        o = ba(Math.sqrt(M * M + F * F)),
        g = Re(k, M),
        f = 2e-4 < Math.abs(g) ? g * Ee : 0,
        p = E ? 1 / (E < 0 ? -E : E) : 0),
        r.svg && (O = t.getAttribute("transform"),
        r.forceCSS = t.setAttribute("transform", "") || !Ed(kd(t, Ne)),
        ...
        e.force3D = 0,
        er(t, e)
    }, Ze = "0deg", Qe = "0px", tr = ") ", er = function _renderCSSTransforms(t, e) {
        var r = e || this
          , i = r.xPercent
          , n = r.yPercent
          , a = r.x
          ...
          , b = "auto" === m && t && 1 !== t || !0 === m;
        if (v && (l !== Ze || h !== Ze)) {
            var T, w = parseFloat(h) * Fe, x = Math.sin(w), k = Math.cos(w);
            w = parseFloat(l) * Fe,
            T = Math.cos(w),
            a = Kd(g, a, x * T * -v),
            s = Kd(g, s, -Math.sin(w) * -v),
            o = Kd(g, o, k * T * -v + v)
        }
        c !== Qe && (y += "perspective(" + c + tr),
        (i || n) && (y += "translate(" + i + "%, " + n + "%) "),
        !b && a === Qe && s === Qe && o === Qe || (y += o !== Qe || b ? "translate3d(" + a + ", " + s + ", " + o + ") " : "translate(" + a + ", " + s + tr),
        u !== Ze && (y += "rotate(" + u + tr),
        h !== Ze && (y += "rotateY(" + h + tr),
        l !== Ze && (y += "rotateX(" + l + tr),
        ...
        a = m,
        i = n = 0),
        (x && !~(l + "").indexOf("px") || k && !~(f + "").indexOf("px")) && (x = vd(g, "x", l, "px"),
        k = vd(g, "y", f, "px")),
        (v || y || b || T) && (x = ba(x + v - (v * r + y * n) + b),
        k = ba(k + y - (v * i + y * a) + T)),
        (u || h) && (s = g.getBBox(),
    ...
    var ir, nr, ar, sr = {
        ...
        init: function init(t, e, r, i, n) {
            ...
            e)
                ...
                !ft[f] || !Ob(f, e, r, i, t, n)))
                    ...
                    "string" === h && ~s.indexOf("random(") && (s = bb(s)),
                    l)
                        l(this, t, f, s, r) && (y = 1);
                        ...
                        s += "",
                        d = Ma(a),
                        (p = Ma(s)) ? d !== p && (a = vd(t, f, a, p) + p) : d && (s += d),
                        this.add(T, "setProperty", a, s, i, n, 0, 0, f);
                    else if ("undefined" !== h) {
                        if (a = w && f in w ? "function" == typeof w[f] ? w[f].call(r, i, t, n) : w[f] : wd(t, f),
                        u = parseFloat(a),
                        (_ = "string" === h && "=" === s.charAt(1) ? +(s.charAt(0) + "1") : 0) && (s = s.substr(2)),
                        o = parseFloat(s),
                        f in qe && ("autoAlpha" === f && (1 === u && "hidden" === wd(t, "visibility") && o && (u = 0),
                        td(this, T, "visibility", u ? "inherit" : "hidden", o ? "inherit" : "hidden", !o)),
                        "scale" !== f && "transform" !== f && ~(f = qe[f]).indexOf(",") && (f = f.split(",")[0])),
                        c = f in ze)
                            if (m || ((g = t._gsap).renderTransform && !e.parseTransform || He(t, e.parseTransform),
                            v = !1 !== e.smoothOrigin && g.smooth,
                            (m = this._pt = new ie(this._pt,T,Ne,0,1,g.renderTransform,g,0,-1)).dep = 1),
                            "scale" === f)
                                ...
                                if ("transformOrigin" === f) {
                                    s = zd(s),
                                    g.svg ? Hd(t, s, 0, v, 0, this) : ((p = parseFloat(s.split(" ")[2]) || 0) !== g.zOrigin && td(this, g, "zOrigin", g.zOrigin, p),
                                    td(this, T, f, Ke(a), Ke(s)));
                                    continue
                                }
                                if ("svgOrigin" === f) {
                                    Hd(t, s, 1, v, 0, this);
                            ...
                            f in T || (f = Ue(f) || f);
                        if (c || (o || 0 === o) && (u || 0 === u) && !Le.test(s) && f in T)
                            o = o || 0,
                            (d = (a + "").substr((u + "").length)) !== (p = Ma(s) || (f in Y.units ? Y.units[f] : d)) && (u = vd(t, f, a, p)),
                            this._pt = new ie(this._pt,c ? g : T,f,u,_ ? _ * o : o - u,c || "px" !== p && "zIndex" !== f || !1 === e.autoRound ? Wc : Zc),
                            this._pt.u = p || 0,
                            d !== p && (this._pt.b = a,
                            this._pt.r = Yc);
                        else if (f in T)
                            xd.call(this, t, f, a, s);
                        else {
                            if (!(f in t)) {
                                M(f, s);
                                continue
        ...
        getSetter: function getSetter(t, e, i) {
            ...
            e in ze && e !== Ye && (t._gsap.x || wd(t, "x")) ? i && de === i ? "scale" === e ? dd : cd : (de = i || {}) && ("scale" === e ? ed : fd) : t.style && !r(t.style[e]) ? ad : ~e.indexOf("-") ? bd : Ht(t, e)
        },
        core: {
            _removeProperty: sd,
            _getMatrix: Gd
    ...
    ar = aa((ir = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent") + "," + (nr = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", function(t) {
        ze[t] = 1
    }),
    aa(nr, function(t) {
        Y.units[t] = "deg",
    ...
    qe[ar[13]] = ir + "," + nr,
    aa("0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY", function(t) {
        var e = t.split(":");
        qe[e[1]] = ar[e[0]]
    }),
...
!function(e, t) {
    ...
    function O(t, e) {
        ...
        h[o + i] || (h[o + i] = N(t, r) || (M(t) ? n : function(e) {
    ...
    function Fa(e, t, r, n, o, i, a) {
        ...
        !g && d || (b += (n === nt ? x : y) + ":" + (i + parseFloat(f)) + "px;"),
    ...
    function Ra(e) {
        ...
        if (g !== r || Ve) {
            for (F(); o < z.length; o += 4)
                (t = ke.matchMedia(z[o]).matches) !== z[o + 3] && ((z[o + 3] = t) ? n.push(o) : F(1, z[o]) || V(z[o + 2]) && z[o + 2]());
            for (R(),
            o = 0; o < n.length; o++)
                t = n[o],
                Ie = z[t],
    ...
    function ib(e, t, r, n, o, i, a, s, l, c, f, u) {
        if (V(e) && (e = e(s)),
        U(e) && "max" === e.substr(0, 3) && (e = u + ("=" === e.charAt(4) ? Ea("0" + e.substr(3), r) : 0)),
        W(e))
            a && k(a, r, n, !0);
        else {
            V(t) && (t = t(s));
            var p, d, g, h = ze(t)[0] || Pe, v = ot(h) || {}, m = e.split(" ");
            v && (v.left || v.top) || "none" !== sa(h).display || (g = h.style.display,
        ...
        if (i) {
            var b = e + r
              , x = i._isStart;
            u = "scroll" + n.d2,
            k(i, b, n, x && 20 < b || !x && (f ? Math.max(Pe[u], Ce[u]) : i.parentNode[u]) <= b + 1),
            f && (l = ot(a),
    ...
    function lb(l, e) {
        var c, f, u = O(l, e), p = "_scroll" + e.p2;
        return l[p] = u,
        function getTween(e, t, r, n, o) {
            ...
            (t.modifiers = s)[p] = function(e) {
                return (e = Math.round(u())) !== c && e !== f && 2 < Math.abs(e - c) ? (i.kill(),
    ...
    var Oe, i, ke, _e, Ce, Pe, o, a, s, l, ze, Ee, Ae, c, Le, Ne, f, Re, u, p, d, Fe, Be, r, We, Ie, g, Ve = 1, Ue = [], h = [], Je = Date.now, v = Je(), Ke = 0, Ye = 1, Xe = Math.abs, t = "scrollLeft", n = "scrollTop", m = "left", x = "right", y = "bottom", De = "width", He = "height", qe = "Right", Ze = "Left", je = "Top", $e = "Bottom", Ge = "padding", Qe = "margin", et = "Width", b = "Height", tt = "px", rt = {
        s: t,
        p: m,
        p2: Ze,
        os: x,
        ...
        a: "x",
        sc: function sc(e) {
            return arguments.length ? ke.scrollTo(e, nt.sc()) : ke.pageXOffset || _e[t] || Ce[t] || Pe[t] || 0
        }
    }, nt = {
        s: n,
        p: "top",
        ...
        op: rt,
        sc: function sc(e) {
            return arguments.length ? ke.scrollTo(rt.sc(), e) : ke.pageYOffset || _e[n] || Ce[n] || Pe[n] || 0
        }
    }, ot = function _getBounds(e, t) {
        var r = t && "matrix(1, 0, 0, 1, 0, 0)" !== sa(e)[f] && Oe.to(e, {
            x: 0,
            y: 0,
            xPercent: 0,
            yPercent: 0,
        ...
        o[r.p] = t + "px",
        Oe.set(e, o)
    }, st = [], lt = {}, _ = {}, C = [], z = [], E = function _dispatch(e) {
        return _[e] && _[e].map(function(e) {
            return e()
        }) || C
    }, A = [], R = function _revertRecorded(e) {
        for (var t = 0; t < A.length; t += 4)
            e && A[t + 3] !== e || (A[t].style.cssText = A[t + 1],
            A[t + 2].uncache = 1)
        ...
        if (ct = n < I ? -1 : 1,
        I = n,
        r && (Ke && !Ne && 200 < t - Ke && (Ke = 0,
        E("scrollEnd")),
        Ae = v,
        v = t),
        ct < 0) {
            for (Re = e; Re--; )
                st[Re] && st[Re].update(0, r);
            ct = 1
        } else
            for (Re = 0; Re < e; Re++)
                st[Re] && st[Re].update(0, r);
        l = 0
    }, H = [m, "top", y, x, Qe + $e, Qe + qe, Qe + je, Qe + Ze, "display", "flexShrink", "float"], q = H.concat([De, He, "boxSizing", "max" + et, "max" + b, "position", Qe, Ge, Ge + je, Ge + qe, Ge + $e, Ge + Ze]), j = /([A-Z])/g, ft = function _setState(e) {
        if (e)
    ...
    var G = (ScrollTrigger.prototype.init = function init(y, w) {
        ...
        Ye) {
            ...
            l = V(pe.snapTo) ? pe.snapTo : "labels" === pe.snapTo ? function _getLabels(i) {
                return function(e) {
            ...
            }(w) : Oe.utils.snap(pe.snapTo),
            c = pe.duration || {
                min: .1,
                max: 2
            },
            c = X(c) ? Ee(c.min, c.max) : Ee(c, c),
            $ = Oe.delayedCall(pe.delay || o / 2 || .1, function() {
            ...
            se && (!1 === le || le === Qe || (le = !(!le && "flex" === sa(se.parentNode).display) && Ge),
            we.pin = se,
            !1 !== y.force3D && Oe.set(se, {
                force3D: !0
            }),
            (n = Oe.core.getCache(se)).spacer ? B = n.pinState : (n.spacer = Y = _e.createElement("div"),
            Y.setAttribute("class", "pin-spacer" + (i ? " pin-spacer-" + i : "")),
            n.pinState = B = fb(se)),
            ...
            we.revert = function(e) {
                var t = !1 !== e || !we.enabled
                  , r = Le;
                t !== T && (t && (Q = Math.max(we.scroll(), we.scroll.rec || 0),
                G = we.progress,
                ee = w && w.progress()),
                E && [E, A, L, R].forEach(function(e) {
                ...
                }(se, Y, B) : de && we.isActive || cb(se, Y, sa(se), Z)),
                T = t)
            }
            ,
            we.refresh = function(e) {
                if (!Le && we.enabled)
                    if (se && e && Ke)
                        za(ScrollTrigger, "scrollEnd", Sa);
                    else {
                        Le = 1,
                        j && j.pause(),
                        ce && w && w.progress(0).invalidate(),
                        T || we.revert();
                        for (var t, r, n, o, i, a, s, l, c, f = Se(), u = Me(), p = S(he, te), d = 0, g = 0, h = y.end, v = y.endTrigger || ae, m = y.start || (0 === y.start ? 0 : se || !ae ? "0 0" : "0 100%"), b = ae && Math.max(0, st.indexOf(we)) || 0, x = b; x--; )
                            !(s = st[x].pin) || s !== ae && s !== se || st[x].revert();
                        for (C = ib(m, ae, f, te, we.scroll(), E, L, we, u, ye, me, p) || (se ? -.001 : 0),
                        V(h) && (h = h(we)),
                        U(h) && !h.indexOf("+=") && (~h.indexOf(" ") ? h = (U(m) ? m.split(" ")[0] : "") + h : (d = Ea(h.substr(2), f),
                        h = U(m) ? m : C + d,
                        v = ae)),
                        z = Math.max(C, ib(h || (v ? "100% 0" : p), v, f, te, we.scroll() + d, A, R, we, u, ye, me, p)) || -.001,
                        F = z - C || (C -= .01) && .001,
                        d = 0,
                        x = b; x--; )
                            (s = (a = st[x]).pin) && a.start - a._pinPush < C && (t = a.end - a.start,
                            s === ae && (d += t),
                            s === se && (g += t));
                        if (C += d,
                        z += d,
                        ...
                        se)
                            ...
                            !p && 1 < z && ((ve ? Pe : he).style["overflow-" + te.a] = "scroll"),
                            cb(se, Y, t),
                            K = fb(se),
                            r = ot(se, !0),
                            l = me && O(he, o ? rt : nt)(),
                            le && ((Z = [le + te.os2, F + g + tt]).t = Y,
                            (x = le === Ge ? wa(se, te) + F + g : 0) && Z.push(te.d, x + tt),
                            ft(Z),
                            me && we.scroll(Q)),
                            me && ((i = {
                                ...
                                position: "fixed"
                            })[De] = i.maxWidth = Math.ceil(r.width) + tt,
                            i[He] = i.maxHeight = Math.ceil(r.height) + tt,
                            i[Qe] = i[Qe + je] = i[Qe + qe] = i[Qe + $e] = i[Qe + Ze] = "0",
                            i[Ge] = t[Ge],
                            i[Ge + je] = t[Ge + je],
                            i[Ge + qe] = t[Ge + qe],
                            i[Ge + $e] = t[Ge + $e],
                        ...
                        we.revert(!1),
                        Le = 0,
                        w && ge && w._initted && w.progress(ee, !0).render(w.time(), !0, !0),
                        G !== we.progress && (j && w.totalProgress(G, !0),
                        we.progress = G,
                        we.update()),
            ...
            we.update = function(e, t) {
                var r, n, o, i, a, s = we.scroll(), l = e ? 0 : (s - C) / F, c = l < 0 ? 0 : 1 < l ? 1 : l || 0, f = we.progress;
                if (t && (_ = k,
                k = s,
                pe && (x = b,
                b = w && !ge ? w.totalProgress() : c)),
                fe && !c && se && !Le && !Ve && Ke && C < s + (s - _) / (Je() - Ae) * fe && (c = 1e-4),
                c !== f && we.enabled) {
                    if (i = (a = (r = we.isActive = !!c && c < 1) != (!!f && f < 1)) || !!c != !!f,
                    we.direction = f < c ? 1 : -1,
                    we.progress = c,
                    ge || (!j || Le || Ve ? w && w.totalProgress(c, !!Le) : (j.vars.totalProgress = c,
                    j.invalidate().restart())),
                    se)
                        if (e && le && (Y.style[le + te.os2] = h),
                        me) {
                            if (i) {
                                if (o = !e && f < c && s < z + 1 && s + 1 >= S(he, te),
                                de)
                                    if (e || !r && !o)
                                        kb(se, Y);
                                    else {
                    ...
                    ne && (a || ue && c && (c < 1 || !We)) && ze(ne.targets).forEach(function(e) {
                        return e.classList[r || ue ? "add" : "remove"](ne.className)
                    }),
                    !re || ge || e || re(we),
                    i && !Le ? (n = c && !f ? 0 : 1 === c ? 1 : 1 === f ? 2 : 3,
                    ge && (o = !a && "none" !== xe[n + 1] && xe[n + 1] || xe[n],
                    w && ("complete" === o || "reset" === o || o in w) && ("complete" === o ? w.pause().totalProgress(1) : "reset" === o ? w.restart(!0).pause() : w[o]()),
                    re && re(we)),
                    !a && We || (oe && a && oe(we),
                    be[n] && be[n](we),
                    ue && (1 === c ? we.kill(!1, 1) : be[n] = 0),
                    a || be[n = 1 === c ? 1 : 3] && be[n](we))) : ge && re && !Le && re(we)
                }
            ...
            we.enable = function() {
                ...
                w && w.add ? Oe.delayedCall(.01, function() {
    ...
    ScrollTrigger.register = function register(e) {
        if (!i && (Oe = e || L(),
        K() && window.document && (ke = window,
        _e = document,
        Ce = _e.documentElement,
        Pe = _e.body),
        Oe && (ze = Oe.utils.toArray,
        Ee = Oe.utils.clamp,
        ...
        Pe))) {
            ...
            , _e, "DOMContentLoaded", B, ke, "load", function() {
                return Ke || B()
            }
            , ke, "resize", La],
            T(za)
    ...
    ScrollTrigger.config = function config(e) {
        ...
        "autoRefreshEvents"in e && (T(Aa) || T(za, e.autoRefreshEvents || "none"),
    ...
    ScrollTrigger.matchMedia = function matchMedia(e) {
        ...
        for (r in e)
            n = z.indexOf(r),
            o = e[r],
            "all" === (Ie = r) ? o() : (t = ke.matchMedia(r)) && (t.matches && (i = o()),
            ~n ? (z[n + 1] = Z(z[n + 1], o),
            z[n + 2] = Z(z[n + 2], i)) : (n = z.length,
            z.push(r, o, i),
            t.addListener ? t.addListener(Ra) : t.addEventListener("change", Ra)),
            z[n + 3] = t.matches),
            Ie = 0;
        return z
    }
    ...
    ScrollTrigger.clearMatchMedia = function clearMatchMedia(e) {
        e || (z.length = 0),
        0 <= (e = z.indexOf(e)) && z.splice(e, 4)
    }
    ,
    ScrollTrigger);
    function ScrollTrigger(e, t) {
        i || ScrollTrigger.register(Oe) || console.warn("Please gsap.registerPlugin(ScrollTrigger)"),
        this.init(e, t)
    }
    G.version = "3.6.0",
    ...
    G.batch = function(e, t) {
        ...
        for (r in t)
            o[r] = "on" === r.substr(0, 2) && V(t[r]) && "onRefreshInit" !== r ? ei(0, t[r]) : t[r];
        return V(a) && (a = a(),
